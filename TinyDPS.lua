...
if GetLocale() == "koKR" then
	...
	tdpsL.helpOthers = "주요 애드온 옵션에 접근하려면 애드온 창에서 마우스 오른쪽 버튼을 클릭하세요."
	...
	tdpsL.helpParameters1 = "/tdps help | reset | damage | healing | whisper <name>"
	tdpsL.helpParameters2 = "/tdps visiblebars <number> | reportlength <number>"
	tdpsL.helpOthers = "Чтобы получить доступ к основным настройкам аддона, щелкните правой кнопкой мыши на рамке аддона."
	...
	tdpsL.helpParameters1 = "/tdps help | reset | damage | healing | whisper <name>"
	tdpsL.helpParameters2 = "/tdps visiblebars <number> | reportlength <number>"
	tdpsL.helpOthers = "Um auf die Haupt-Addon-Optionen zuzugreifen, klicken Sie mit der rechten Maustaste auf den Addon-Rahmen."
	...
	tdpsL.helpOthers = "Pour accéder aux options principales de l'addon, faites un clic droit sur le cadre de l'addon."
	...
	tdpsL.helpOthers = "Per accedere alle opzioni principali dell'addon, fai clic destro sul riquadro dell'addon."
	...
	tdpsL.fight = "Combate"
	tdpsL.allFight = "Total de todos os combates (Dados Gerais)"
	tdpsL.current = "Atual"
	tdpsL.resetAllData = "Redefinir todos os dados"
	tdpsL.showDamage = "Mostrar dano"
	tdpsL.showHealing = "Mostrar cura"
	
	tdpsL.report = "Relatar"
	tdpsL.top3 = "Top 3"
	tdpsL.top5 = "Top 5"
	tdpsL.top10 = "Top 10"
	tdpsL.say = "Dizer"
	tdpsL.instance = "Instância"
	tdpsL.raid = "Raide"
	tdpsL.party = "Grupo"
	tdpsL.guild = "Guilda"
	tdpsL.officer = "Oficiais"
	tdpsL.whisper = "Sussurrar ao alvo"
	tdpsL.whisper2 = "Sussurrar para <Nome>"
	tdpsL.channel = "Canal"
	
	tdpsL.options = "Opções"
	tdpsL.text = "Texto"
	tdpsL.size = "Tamanho"
	tdpsL.increase = "Aumentar"
	tdpsL.decrease = "Diminuir"
	tdpsL.font = "Fonte"
	tdpsL.layout = "Layout"
	tdpsL.outline = "Contorno"
	tdpsL.nudge = "Ajustar"
	...
	tdpsL.dps = "DPS"
	tdpsL.rank = "Rank"
	tdpsL.percent = "Porcentagem"
	tdpsL.amount = "Quantidade"
	tdpsL.short = "Formato curto"
	tdpsL.none = "Nenhum"
	tdpsL.thin = "Fino"
	tdpsL.thick = "Grosso"
	tdpsL.shadow = "Sombreado"
	tdpsL.mono = "Monocromático"
	
	tdpsL.bars = "Barras"
	tdpsL.height = "Altura"
	tdpsL.spacing = "Espaçamento"
	tdpsL.maximum = "Barras visíveis"
	tdpsL.oneYourself = "1 (Você)"
	tdpsL.five = "5"
	tdpsL.ten = "10"
	tdpsL.fifteen = "15"
	tdpsL.twenty = "20"
	...
	tdpsL.colors = "Cores"
	tdpsL.barBackdrop = "Fundo das barras"
	tdpsL.frameBorder = "Borda do quadro"
	tdpsL.frameBackdrop = "Fundo do quadro"
	tdpsL.dimClassColors = "Escurecer cores de classes"
	tdpsL.resetClassColors = "Redefinir cores de classes"
	tdpsL.swapBarTextColor = "Trocar cor entre barra e texto"
	
	tdpsL.history = "      %i Histórico de combates"
	tdpsL.keepOnlyBossFights = "Manter apenas combates contra chefes"
	
	tdpsL.various = "Vários"
	tdpsL.hideAlways = "Sempre ocultar"
	tdpsL.hideInPvP = "Ocultar no PvP"
	tdpsL.hideInBattle = "Ocultar em Batalha de Mascotes"
	tdpsL.hideWhenSolo = "Ocultar quando sozinho"
	tdpsL.hideInCombat = "Ocultar em combate"
	tdpsL.hideOutOfCombat = "Ocultar fora de combate"
	tdpsL.growUpwards = "Crescer para cima"
	tdpsL.minimapButton = "Botão do minimapa"
	tdpsL.trackSpellDetails = "Rastrear detalhes de feitiços"
	tdpsL.resetOnNewGroup = "Redefinir ao formar novo grupo"
	tdpsL.refreshEverySecond = "Atualizar a cada segundo"
	
	tdpsL.spells = "      %i Feitiços nos detalhes"
	tdpsL.targets = "      %i Alvos nos detalhes"
	
	tdpsL.close = "Fechar"
	tdpsL.empty = "<Vazio>"
	
	tdpsL.helpVersion = "Versão"
	tdpsL.helpMove = "Para mover: segure shift e arraste o quadro"
	tdpsL.helpResize = "Para redimensionar: arraste o canto inferior direito"
	tdpsL.helpToggle = "Para alternar a visibilidade: digite /tdps para mostrar ou ocultar"
	tdpsL.helpParameters1 = "Outros comandos: /tdps help | reset | damage | healing | whisper <nome>"
	tdpsL.helpParameters2 = "/tdps visiblebars <número> | reportlength <número>"
	tdpsL.helpOthers = "Para acessar as opções principais do AddOn, clique com o botão direito na janela do addon."	
	
	tdpsL.allClear = "Todos os dados foram redefinidos"
	tdpsL.personal = "Pessoal"
	tdpsL.byPets = "Acompanhantes"
	tdpsL.topAbilities = "Melhores habilidades"
	tdpsL.topTargets = "Melhores alvos"
	
	tdpsL.noTarget = "Alvo inválido ou não selecionado"
	tdpsL.noData = "Sem dados para relatar"
	...
	tdpsL.overallData = "dados gerais"
	tdpsL.currentFight = "combate atual"
	tdpsL.lastFight = "último combate"
	tdpsL.melee = "corpo a corpo"
	...
	tdpsL.helpParameters1 = "/tdps help | reset | damage | healing | whisper <name>"
	tdpsL.helpParameters2 = "/tdps visiblebars <number> | reportlength <number>"
	tdpsL.helpOthers = "要访问主插件选项，请右键点击插件框架。"
	...
	tdpsL.helpParameters1 = "/tdps help | reset | damage | healing | whisper <name>"
	tdpsL.helpParameters2 = "/tdps visiblebars <number> | reportlength <number>"
	tdpsL.helpOthers = "Para acceder a las opciones principales del addon, haz clic derecho sobre el marco del addon."
	...
	tdpsL.helpVersion = "Version"
	tdpsL.helpMove = "To move: hold shift and drag the frame"
	tdpsL.helpResize = "To resize: drag the bottom right corner"
	tdpsL.helpToggle = "To toggle: type /tdps to hide or show"
	tdpsL.helpParameters1 = "Other slash commands: /tdps help | reset | damage | healing | whisper <name>"
	tdpsL.helpParameters2 = "/tdps visiblebars <number> | reportlength <number>"
	tdpsL.helpOthers = "To access the main AddOn options, right click on the addon frame."
...
tdpsFrame:SetResizeBounds(300, 200, 800, 500)
...
tdpsButtonTexture:SetWidth(22)
tdpsButtonTexture:SetHeight(22)
tdpsButtonTexture:SetTexture([[Interface\AddOns\TinyDPS\Textures\tinydps-32.blp]])
...
tdpsButtonTexturePushed:SetWidth(22)
tdpsButtonTexturePushed:SetHeight(22)
tdpsButtonTexturePushed:SetTexture([[Interface\AddOns\TinyDPS\Textures\tinydps-32.blp]])
...
local function ver()
	echo(tdpsL.helpVersion.." "..C_AddOns.GetAddOnMetadata("TinyDPS", "Version")..".")
end
...
tdpsFrame:SetScript("OnEvent", function(self, event)
	local addonVer = C_AddOns.GetAddOnMetadata and C_AddOns.GetAddOnMetadata("TinyDPS", "Version")
...
-- Interface Options Addons Menu Hook

local tinyDPSInterfaceOptions = CreateFrame("Frame", "MySimpleFrame", UIParent)
tinyDPSInterfaceOptions:SetSize(300, 100)  -- Definir o tamanho do frame
tinyDPSInterfaceOptions:SetPoint("TOPLEFT", 10, -10)  -- Posicionar o frame no canto superior esquerdo

local title = tinyDPSInterfaceOptions:CreateFontString(nil, "OVERLAY", "GameFontNormalLarge")
title:SetPoint("TOPLEFT", 10, -10)
title:SetText("TinyDPS " .. tdpsL.helpVersion .. " " .. C_AddOns.GetAddOnMetadata("TinyDPS", "Version"))  

local p1 = tinyDPSInterfaceOptions:CreateFontString(nil, "OVERLAY", "GameFontWhite")
p1:SetPoint("TOPLEFT", 10, -50)
p1:SetText(tdpsL.helpMove)  

local p2 = tinyDPSInterfaceOptions:CreateFontString(nil, "OVERLAY", "GameFontWhite")
p2:SetPoint("TOPLEFT", 10, -75)
p2:SetText(tdpsL.helpResize)  

local p3 = tinyDPSInterfaceOptions:CreateFontString(nil, "OVERLAY", "GameFontWhite")
p3:SetPoint("TOPLEFT", 10, -100)
p3:SetText(tdpsL.helpParameters1)  

local p4 = tinyDPSInterfaceOptions:CreateFontString(nil, "OVERLAY", "GameFontWhite")
p4:SetPoint("TOPLEFT", 10, -125)
p4:SetText(tdpsL.helpParameters2)

local p5 = tinyDPSInterfaceOptions:CreateFontString(nil, "OVERLAY", "GameFontWhite")
p5:SetPoint("TOPLEFT", 10, -150)
p5:SetText(tdpsL.helpOthers)


-- Hook para adicionar o frame na Interface Options
local Category = Settings.RegisterCanvasLayoutCategory(tinyDPSInterfaceOptions, "TinyDPS")

-- Registrar a categoria do addon
Settings.RegisterAddOnCategory(Category)

-- Esconder o frame por padrão, ele só aparecerá nas opções
tinyDPSInterfaceOptions:Hide()
